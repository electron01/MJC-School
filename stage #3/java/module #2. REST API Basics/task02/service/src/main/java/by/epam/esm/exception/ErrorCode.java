...
public enum  ErrorCode {
    ...
    USER_LOGIN_IS_ALREADY_EXISTS(HttpStatus.BAD_REQUEST,"40005","This user login is already exist"),
    ...
    NOT_FIND_USER_BY_ID(HttpStatus.NOT_FOUND,"40403","Not find user by this id"),
    NOT_FIND_ORDER_BY_ID(HttpStatus.NOT_FOUND,"40404","Not find order by this id"),
